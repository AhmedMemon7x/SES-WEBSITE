...
function ExecutiveCard({ member, index }) {
  ...
  const [hov, setHov] = useState(false);
  const { initials, color, name, role, batch, bio, image } = member;
...
function TeamPage({ setPage }) {
  ...
  const executives = [
    { initials:"FG", color:C.primary,  name:"Faraz Ghani",       role:"President",         batch:"SE Batch 2022", bio:"Leading SES with a focus on technical excellence and community growth. Passionate about innovation and building strong tech communities at MUET.", linkedin:"#", github:"#", image:"https://i.ibb.co/ZLNYDm3/Faraz.jpg" },
    { initials:"SA", color:C.accent,   name:"Sarwat Aijaz",      role:"Vice President",    batch:"SE Batch 2022", bio:"Overseeing all operations and member experience. Strong background in project management and building inclusive tech communities at MUET.", linkedin:"#", github:"#", image:"https://i.ibb.co/QjgqWJ3/Vp-Sarwat-Aijaz.jpg" },
    { initials:"GK", color:"#7C3AED",  name:"Gotam Kumar",       role:"General Secretary", batch:"SE Batch 2022", bio:"Manages internal communication, documentation, and coordination between all SES departments. Passionate about developer tooling and automation.", linkedin:"#", github:"#", image:"https://i.ibb.co/GdT14HM/GS-Gotam-Kumar.jpg" },
    { initials:"SS", color:"#DB2777",  name:"Sachal Sahito",     role:"Treasurer",         batch:"SE Batch 2023", bio:"Handles all financial matters, budgeting, and resource allocation for SES events and activities. Expert in financial planning and accounting.", linkedin:"#", github:"#", image:"https://i.ibb.co/4tcYVzs/Treasurer-Sachal-Sahito.jpg" },
    { initials:"GM", color:C.warning,  name:"Ghulam Mustafa",    role:"Joint Secretary",   batch:"SE Batch 2023", bio:"Assists the General Secretary in administrative tasks and member coordination. Focused on improving internal processes and member engagement.", linkedin:"#", github:"#", image:"https://i.ibb.co/G7SkWf3/JS-Ghulam-Mustafa.jpg" },
  ];
  ...
  const teams = [
    { 
      ...
      lead: { initials: "MA", name: "Masood Ali", role: "Head Director Management", image:"https://i.ibb.co/MS2zvxf/Head-management-Masood-Ali.png" },
      members: [
        { initials:"HM", name:"Humera Masood", image:"https://i.ibb.co/r3km8T8/Mangement-Humera-Masood.jpg" },
        { initials:"SA", name:"Soorat Ali", image:"https://i.ibb.co/S5yJRNb/Soorat-Management.jpg" },
        { initials:"MA", name:"Muhammad Ahmed", image:"https://i.ibb.co/nCGrMhb/Management-Ahmed-Siddiqui.jpg" },
        { initials:"RN", name:"Rutba Nisar", image:"https://i.ibb.co/hfZ58MC/Management-rutba-nisar.jpg" },
      ]
    },
    { 
      icon: "🎨", 
      ...
      lead: { initials: "MQ", name: "Maryam Qureshi", role: "Head Director Designing", image:"https://i.ibb.co/pLzXbHy/Maryam-Qureshi.png" },
      members: [
        { initials:"MM", name:"Mahrukh Mahar", image:"https://i.ibb.co/hfCM5dt/Design-Mahrukh-mahar.jpg" },
        { initials:"M", name:"Mustafa", image:"https://i.ibb.co/YPgrNCK/Design-Mustafa-Jan.jpg" },
      ]
    },
    { 
      icon: "📱", 
      ...
      lead: { initials: "UM", name: "Uroosham Memon", role: "Head Director Media", image:"https://i.ibb.co/GtVDKFx/Uroosham-Head-Media.jpg" },
      members: [
        { initials:"RM", name:"Rubab Majid", image:"https://i.ibb.co/gyF3dJX/Rubab-Majid-Media.jpg" },
        { initials:"HN", name:"Hafsa Noor", image:"https://i.ibb.co/phd9GCb/Media-Hafsa-Noor-Khokhar.jpg" },
        { initials:"AZ", name:"Aimon Zehra", image:"https://i.ibb.co/S7T8zGG/Media-Aimon-Zehra.jpg" },
      ]
    },
    { 
      icon: "📢", 
      ...
      lead: { initials: "ZK", name: "Zain Khan Awan", role: "Head Director Marketing", image:"https://i.ibb.co/ZzBK5jY/Head-marketing-Zain-Khan.jpg" },
      members: [
        { initials:"AH", name:"Abdul Haseeb", image:"https://i.ibb.co/7SqXgHz/Marketin-Abdul-Haseeb-Memon.jpg" },
      ]
    },
    { 
      icon: "📝", 
      ...
      lead: { initials: "AS", name: "Aiman Shaikh", role: "Head Director Editorial", image:"https://i.ibb.co/gwGwtCx/Head-editorial-Aiman-Shaikh.jpg" },
      members: [
        { initials:"MR", name:"Mahad Shah Rashidi", image:"https://i.ibb.co/8KJR8gG/Editorial-Mahad-Rashdi.jpg" },
      ]
    },
    { 
      icon: "🎯", 
      ...
      lead: { initials: "HR", name: "Haram Rajput", role: "Head Director Logistics", image:"https://i.ibb.co/59kmQR1/Head-logistics-Mohammad-Haram-Rajput.jpg" },
      members: [
        { initials:"JA", name:"Jahanzaib Ansari", image:"https://i.ibb.co/b6NT4Qb/Jahanzaib-Logistics.jpg" },
      ]
    },
    { 
      icon: "🎬", 
      ...
      lead: { initials: "HA", name: "Hassan Ahmed", role: "Head Director Videography", image:"https://i.ibb.co/WzkV9vv/OC-Ha-Ssan-Ahme-D.jpg" },
      members: [
        { initials:"RS", name:"Rania Shah", image:"https://i.ibb.co/sv0bDSm/Video-Rania-Shah.jpg" },
      ]
    },
    { 
      icon: "📷", 
      ...
      lead: { initials: "RZ", name: "Raza Zaeem", role: "Head Director Photography", image:"https://i.ibb.co/FxhpYm9/Head-photo-Zaeem-Raza.jpg" },
      members: [
        { initials:"NJ", name:"Nashra Jahejo", image:"https://i.ibb.co/wwsBvPt/Photo-Nashra-Jahejo.jpg" },
      ]
    },
    { 
      icon: "🌐", 
      ...
      lead: { initials: "TB", name: "Tayyaba Bhatti", role: "Head of Organization Council", image:"https://i.ibb.co/YcfTbmX/Head-oc-Tayyaba-Bhatti.jpg" },
      members: [
        { initials:"AB", name:"Abdul Basit", image:"https://i.ibb.co/mqQL5T4/OC-basit-memon.jpg" },
        { initials:"RS", name:"Rafay Shakeel", image:"https://i.ibb.co/4RFvQnn/OC-Rafay-Shakeel.jpg" },
        { initials:"HN", name:"Hadisa Naqvi", image:"https://i.ibb.co/DrrDrvz/Hadisa-Naqvi-OC.jpg" },
        { initials:"HS", name:"Hadisa Syed", image:"https://i.ibb.co/GQN8nQD/OC-Hadisa-Syed.jpg" },
        { initials:"SN", name:"Saria Nadeem", image:"https://i.ibb.co/LYvrK6j/OC-Saria-Nadeem.jpg" },
        { initials:"GK", name:"Ghulam Hussain Khuhro", image:"https://i.ibb.co/Y2SzQ6v/OC-Ghulam-Hussain-Khuhro.jpg" },
        { initials:"AF", name:"Areej Fatima", image:"https://i.ibb.co/R2k6hNs/OC-Areej-Fatima.jpg" },
      ]
    },
  ];
  ...
  const pastTeams = [
    {
      year: "2023-2024",
      members: [
        { initials:"FG", color:C.primary,  name:"Faraz Ghani",       role:"President", image:"https://i.ibb.co/ZLNYDm3/Faraz.jpg" },
        { initials:"SA", color:C.accent,   name:"Sarwat Aijaz",      role:"Vice President", image:"https://i.ibb.co/QjgqWJ3/Vp-Sarwat-Aijaz.jpg" },
        { initials:"SS", color:"#7C3AED", name:"Sachal Sahito",     role:"Treasurer", image:"https://i.ibb.co/4tcYVzs/Treasurer-Sachal-Sahito.jpg" },
        { initials:"GK", color:C.success,  name:"Gotam Kumar",       role:"General Secretary", image:"https://i.ibb.co/GdT14HM/GS-Gotam-Kumar.jpg" },
        { initials:"GM", color:"#DB2777", name:"Ghulam Mustafa",    role:"Joint Secretary", image:"https://i.ibb.co/G7SkWf3/JS-Ghulam-Mustafa.jpg" },
        { initials:"MA", color:C.warning,  name:"Masood Ali",        role:"Head Director Management", image:"https://i.ibb.co/MS2zvxf/Head-management-Masood-Ali.png" },
        { initials:"HM", color:C.primary,  name:"Humera Masood",     role:"Director Management", image:"https://i.ibb.co/r3km8T8/Mangement-Humera-Masood.jpg" },
        { initials:"SA", color:C.accent,   name:"Soorat Ali",        role:"Director Management", image:"https://i.ibb.co/S5yJRNb/Soorat-Management.jpg" },
        { initials:"MA", color:"#7C3AED", name:"Muhammad Ahmed",    role:"Director Management", image:"https://i.ibb.co/nCGrMhb/Management-Ahmed-Siddiqui.jpg" },
        { initials:"RN", color:C.success,  name:"Rutba Nisar",       role:"Director Management", image:"https://i.ibb.co/hfZ58MC/Management-rutba-nisar.jpg" },
        { initials:"MQ", color:"#DB2777", name:"Maryam Qureshi",    role:"Head Director Designing", image:"https://i.ibb.co/pLzXbHy/Maryam-Qureshi.png" },
        { initials:"MM", color:C.warning,  name:"Mahrukh Mahar",     role:"Director Designing", image:"https://i.ibb.co/hfCM5dt/Design-Mahrukh-mahar.jpg" },
        { initials:"M",  color:C.primary,  name:"Mustafa",           role:"Director Designing", image:"https://i.ibb.co/YPgrNCK/Design-Mustafa-Jan.jpg" },
        { initials:"UM", color:C.accent,   name:"Uroosham Memon",    role:"Head Director Media", image:"https://i.ibb.co/GtVDKFx/Uroosham-Head-Media.jpg" },
        { initials:"RM", color:"#7C3AED", name:"Rubab Majid",       role:"Director Media", image:"https://i.ibb.co/gyF3dJX/Rubab-Majid-Media.jpg" },
        { initials:"HN", color:C.success,  name:"Hafsa Noor",        role:"Director Media", image:"https://i.ibb.co/phd9GCb/Media-Hafsa-Noor-Khokhar.jpg" },
        { initials:"AZ", color:"#DB2777", name:"Aimon Zehra",       role:"Director Media", image:"https://i.ibb.co/S7T8zGG/Media-Aimon-Zehra.jpg" },
        { initials:"AS", color:C.warning,  name:"Aiman Shaikh",      role:"Head Director Editorial", image:"https://i.ibb.co/gwGwtCx/Head-editorial-Aiman-Shaikh.jpg" },
        { initials:"MR", color:C.primary,  name:"Mahad Shah Rashidi", role:"Director Editorial", image:"https://i.ibb.co/8KJR8gG/Editorial-Mahad-Rashdi.jpg" },
        { initials:"HA", color:C.accent,   name:"Hassan Ahmed",      role:"Head Director Videography", image:"https://i.ibb.co/WzkV9vv/OC-Ha-Ssan-Ahme-D.jpg" },
        { initials:"RS", color:"#7C3AED", name:"Rania Shah",        role:"Director Videography", image:"https://i.ibb.co/sv0bDSm/Video-Rania-Shah.jpg" },
        { initials:"ZK", color:C.success,  name:"Zain Khan Awan",    role:"Head Director Marketing", image:"https://i.ibb.co/ZzBK5jY/Head-marketing-Zain-Khan.jpg" },
        { initials:"AH", color:"#DB2777", name:"Abdul Haseeb",      role:"Director Marketing", image:"https://i.ibb.co/7SqXgHz/Marketin-Abdul-Haseeb-Memon.jpg" },
        { initials:"RZ", color:C.warning,  name:"Raza Zaeem",        role:"Head Director Photography", image:"https://i.ibb.co/FxhpYm9/Head-photo-Zaeem-Raza.jpg" },
        { initials:"NJ", color:C.primary,  name:"Nashra Jahejo",     role:"Director Photography", image:"https://i.ibb.co/wwsBvPt/Photo-Nashra-Jahejo.jpg" },
        { initials:"HR", color:C.accent,   name:"Haram Rajput",      role:"Head Director Logistics", image:"https://i.ibb.co/59kmQR1/Head-logistics-Mohammad-Haram-Rajput.jpg" },
        { initials:"JA", color:"#7C3AED", name:"Jahanzaib Ansari",  role:"Director Logistics", image:"https://i.ibb.co/b6NT4Qb/Jahanzaib-Logistics.jpg" },
        { initials:"TB", color:C.success,  name:"Tayyaba Bhatti",    role:"Head of Organization Council", image:"https://i.ibb.co/YcfTbmX/Head-oc-Tayyaba-Bhatti.jpg" },
        { initials:"AB", color:"#DB2777", name:"Abdul Basit",       role:"Organization Council", image:"https://i.ibb.co/mqQL5T4/OC-basit-memon.jpg" },
        { initials:"RS", color:C.warning,  name:"Rafay Shakeel",     role:"Organization Council", image:"https://i.ibb.co/4RFvQnn/OC-Rafay-Shakeel.jpg" },
        { initials:"HN", color:C.primary,  name:"Hadisa Naqvi",      role:"Organization Council", image:"https://i.ibb.co/DrrDrvz/Hadisa-Naqvi-OC.jpg" },
        { initials:"HS", color:C.accent,   name:"Hadisa Syed",       role:"Organization Council", image:"https://i.ibb.co/GQN8nQD/OC-Hadisa-Syed.jpg" },
        { initials:"SN", color:"#7C3AED", name:"Saria Nadeem",      role:"Organization Council", image:"https://i.ibb.co/LYvrK6j/OC-Saria-Nadeem.jpg" },
        { initials:"GK", color:C.success,  name:"Ghulam Hussain Khuhro", role:"Organization Council", image:"https://i.ibb.co/Y2SzQ6v/OC-Ghulam-Hussain-Khuhro.jpg" },
        { initials:"AF", color:"#DB2777", name:"Areej Fatima",      role:"Organization Council", image:"https://i.ibb.co/R2k6hNs/OC-Areej-Fatima.jpg" },
      ],
      achievements: [
        "Organized Tech Arena 2024 with 200+ participants",
        "Hosted Neural Networks Workshop with NFC University",
        "Launched Web Dev Mastery 2-day workshop",
        "Organized Skill UP With SES Season 2 with Microsoft Learn Student Ambassadors",
        "Hosted Deep Dive into Outcome Based Education seminar",
      ],
    },
    {
      year: "2022-2023",
      members: [
        { initials:"SA", color:C.primary,  name:"Syed Arham Abbas",    role:"President", image:"https://i.ibb.co/Wvy5JNC/A1-FCBF73-DB45-49-AF-983-E-588-CDA789-D78-SES-MUET.jpg" },
        { initials:"AA", color:C.accent,   name:"Ambar Arain",         role:"Vice-President", image:"https://i.ibb.co/LkyxyX2/Ambar-Ambar-Arain.jpg" },
        { initials:"AR", color:"#7C3AED", name:"Abdul Razzaq",        role:"Treasurer", image:"https://i.ibb.co/VJsGVsz/CD1-E341-B-86-AE-4-A28-89-B2-188407-FBE3-B7-Abdul-Razzaq.jpg" },
        { initials:"MA", color:C.success,  name:"Muhammad Adil Memon", role:"General Secretary", image:"https://i.ibb.co/1GfqVKS/Snapchat-1874889576-Muhammad-Adil-memon.jpg" },
        { initials:"QA", color:"#DB2777", name:"Qurban Ali",          role:"Joint Secretary", image:"https://i.ibb.co/Q9jZPxF/IMG-6592-Qurban-Ali-Ogahi.jpg" },
        { initials:"ZK", color:C.warning,  name:"Zarmeena Khan",       role:"Director Management (Head)", image:"https://i.ibb.co/xjGgzhv/IMG-20230530-WA0037-Zarmeena-Khan.jpg" },
        { initials:"AD", color:C.primary,  name:"Agha Durrez Khani",   role:"Director Management", image:"https://i.ibb.co/wYtW0Fy/3-DFBF199-B4-D4-4-A22-95-DF-47-A483-D39-DD5-Agha-Durrez-Khan.jpg" },
        { initials:"AM", color:C.accent,   name:"Ali Muhammad",        role:"Director Management", image:"https://i.ibb.co/Cb4wkPq/2-CE66-F2-A-1-CD8-45-F3-909-A-9-C927-C1-C458-E.jpg" },
        { initials:"ZK", color:"#7C3AED", name:"Zohaib Khoso",        role:"Director Management", image:"https://i.ibb.co/kDgkKFL/ses.jpg" },
        { initials:"MA", color:C.success,  name:"Minal Azhar",         role:"Director Editorial (Head)", image:"https://i.ibb.co/ZS5jtPS/minal.jpg" },
        { initials:"AQ", color:"#DB2777", name:"Ainab Qazi",          role:"Editorial Officer", image:"https://i.ibb.co/jbvsjcx/IMG-0803-Ainab-Kazi.jpg" },
        { initials:"MD", color:C.warning,  name:"Muhammad Daniyal",    role:"Head Director Media", image:"https://i.ibb.co/RYwPVbp/1673766399354-SES-MUET.jpg" },
        { initials:"MS", color:C.primary,  name:"Muhammad Sarosh",     role:"Director Media", image:"https://i.ibb.co/CQ4qnCj/photo-output-Mohammad-sarosh-Shaikh.jpg" },
        { initials:"AK", color:C.accent,   name:"Aashish Kumar",       role:"Director Media", image:"https://i.ibb.co/QbB6f4V/a8341fc5-e216-4fe2-8319-df535bf8810f-Aashish-Kumar.jpg" },
        { initials:"UM", color:"#7C3AED", name:"Uroosham Memon",      role:"Director Media", image:"https://i.ibb.co/Sx5y6sf/Picsart-23-03-05-15-18-50-397-Uroosham-Memon.jpg" },
        { initials:"FG", color:C.success,  name:"Faraz Ghani",         role:"Head Director of Videography", image:"https://i.ibb.co/vzvWzJd/faraz-faraz-temp.jpg" },
        { initials:"VK", color:"#DB2777", name:"Varoon Kumar",        role:"Director of Videography", image:"https://i.ibb.co/P5L8KfQ/IMG-20220207-WA0093-Varoon-Kumar.jpg" },
        { initials:"SA", color:C.warning,  name:"Sabrina Abro",        role:"Director Videography", image:"https://i.ibb.co/kcjBpzz/IMG-8556-Sabrina-Abro.jpg" },
        { initials:"H",  color:C.primary,  name:"Hurain",              role:"Director Videography", image:"https://i.ibb.co/z6zDbZJ/Director-Videography.jpg" },
        { initials:"FQ", color:C.accent,   name:"Faeez Ahmed Qureshi", role:"Director Designer (Head)", image:"https://i.ibb.co/jfSpsC6/SAVE-20220601-063331-FUJ.jpg" },
        { initials:"FN", color:"#7C3AED", name:"Faiz Nadeem",         role:"Director Design", image:"https://i.ibb.co/frjPnJP/419-C1140-Engrfaiz-Nadeem.jpg" },
        { initials:"MQ", color:C.success,  name:"Maryam Qureshi",      role:"Director Designing", image:"https://i.ibb.co/4K05jz8/IMG-20230527-WA0008-Uroosham-Memon.jpg" },
        { initials:"ZA", color:"#DB2777", name:"Zahoor Ahmed",        role:"Director Graphics Design", image:"https://i.ibb.co/qkNMwkP/IMG-20220317-223647-605-Zahoor-Ahmed.jpg" },
        { initials:"MI", color:C.warning,  name:"Muzafar Ibrahim",     role:"Head Director Logistics", image:"https://i.ibb.co/X3gMt5t/95-E8-FC9-F-95-FE-4-B22-9-BD0-2-A11-A27-C9794-Muzafar-Mahar.jpg" },
        { initials:"HR", color:C.primary,  name:"Muhammad Haram Rajput", role:"Director Logistics", image:"https://i.ibb.co/DQqJCNj/IMG-0612-Mohammad-Haram-Rajput.jpg" },
        { initials:"MK", color:C.accent,   name:"M Abdullah Khan",     role:"Director Photography", image:"https://i.ibb.co/JFDgMM3/1-G9-A8993-Muhammad-Abdullah-Khan.jpg" },
        { initials:"K",  color:"#7C3AED", name:"Kashish",             role:"Director Photography", image:"https://i.ibb.co/hKt5CMm/IMG-1764-Chowdhry-Kashish.jpg" },
        { initials:"UH", color:C.success,  name:"Uzair Hussain",       role:"Head Director Marketing", image:"https://i.ibb.co/QYqsj29/uzairs-Uzair-Hussain.jpg" },
        { initials:"GK", color:"#DB2777", name:"Gotam Kumar",         role:"Director Marketing", image:"https://i.ibb.co/yfWkJnk/IMG-20220112-WA0016-1-Gotam-Kumar.jpg" },
        { initials:"AR", color:C.warning,  name:"Ali Raza",            role:"Director Marketing", image:"https://i.ibb.co/K9swFxw/419-C6194-Ali-Raza.jpg" },
        { initials:"UN", color:C.primary,  name:"Usama Nayab",         role:"Lead Developers Team", image:"https://i.ibb.co/KzDp8ys/71-AAB90-B-7-F04-4564-8-C89-0902560-E26-DB-usama-nayab.jpg" },
        { initials:"KA", color:C.accent,   name:"Kashaf Abdullah",     role:"Developer", image:"https://i.ibb.co/XsbxBrj/kashafpic.jpg" },
        { initials:"MA", color:"#7C3AED", name:"Muhammad Arayan",     role:"Developer", image:"https://i.ibb.co/FYFk8D1/1680198541314-memon-aryu.jpg" },
        { initials:"FH", color:C.success,  name:"Fahad Hussain",       role:"Director Developer", image:"https://i.ibb.co/PmtQWCT/inbound2782392963145104133-Fahad-Hussain.jpg" },
        { initials:"SK", color:"#DB2777", name:"Summaiya Khan",       role:"Organization Council (Head)", image:"https://i.ibb.co/Bs7MMWG/IMG-20230321-WA0038-Summiya-Khan.jpg" },
        { initials:"HN", color:C.warning,  name:"Hafsa Noor",          role:"Organization Council", image:"https://i.ibb.co/bL3GCH7/1-Hafsa-Noor-Khokhar.jpg" },
        { initials:"SS", color:C.primary,  name:"Sachal Sahito",       role:"Organization Council", image:"https://i.ibb.co/Vq4jvDm/419-C5496-Sachal-Sahito.jpg" },
        { initials:"NN", color:C.accent,   name:"Nayab Nisar",         role:"Organization Council", image:"https://i.ibb.co/SxhnBWn/IMG-20230314-182209-Nayab-Nisar.jpg" },
        { initials:"T",  color:"#7C3AED", name:"Taneesha",            role:"Organization Council", image:"https://i.ibb.co/hybxdY1/d672e713-4049-4701-b59e-67372bb41b56-Tanisha-Lohana.jpg" },
        { initials:"RS", color:C.success,  name:"Rida Shah",           role:"Organization Council", image:"https://i.ibb.co/vkDcBQj/Screenshot-20230529-010222-Ridda-Batool.jpg" },
        { initials:"ZK", color:"#DB2777", name:"Zain Khan",           role:"Organization Council", image:"https://i.ibb.co/JksB2g8/d4de72e8-d524-434a-82d6-c2f9c695f039-Original-Zain-Khan.jpg" },
        { initials:"AS", color:C.warning,  name:"Areeba Syed",         role:"Organization Council", image:"https://i.ibb.co/V2KPvnw/Hashmi-Areeba-Syed.jpg" },
        { initials:"AS", color:C.primary,  name:"Aina Saeed",          role:"Organization Council", image:"https://i.ibb.co/dWLvqZk/419-C5181-Aina-Saeed.jpg" },
        { initials:"SA", color:C.accent,   name:"Sarwat Aijaz",        role:"Organization Council", image:"https://i.ibb.co/8zwJvgb/IMG-20230416-203156-106-Pak-Blink-Army.jpg" },
        { initials:"TB", color:"#7C3AED", name:"Tayyaba Bhatti",      role:"Organization Council", image:"https://i.ibb.co/Gx5jqfj/IMG-20230322-WA0012-Tayyaba-Bhatti.jpg" },
      ],
      achievements: [
        "Organized Tech N Play - a grand 2-day event",
        "Hosted ALTECH in collaboration with ACM MUET",
        "Launched Data Science Bootcamp with IEEE Computer Society",
        "Organized Skill up with SES Season 1",
        "Hosted Blockchain Security and Web3 seminar",
      ],
    },
    {
      year: "2021-2022",
      members: [
        { initials:"TR", color:C.primary,  name:"Tabish Rehmatullah", role:"President", image:"https://i.ibb.co/6nDbkKn/4-A2-E873-F-69-F4-4523-BAC7-9-C45-BC93-CD80.jpg" },
        { initials:"M",  color:C.accent,   name:"Muskan",             role:"Vice-President", image:"https://i.ibb.co/9ZHGXQX/Muskan.jpg" },
        { initials:"CF", color:"#7C3AED", name:"Chaudhary Faisal",   role:"Treasurer", image:"https://i.ibb.co/5kwxTrD/37-BDB6-DB-C553-46-FB-9-C44-C3-BB1-B1-C01-EA.jpg" },
        { initials:"IB", color:C.success,  name:"Isha Bhutto",        role:"General Secretary", image:"https://i.ibb.co/FXsT4W8/1641562995798.jpg" },
        { initials:"T",  color:"#DB2777", name:"Tooba",              role:"Joint Secretary", image:"https://i.ibb.co/Wpk9gYk/27e7888b-2dbb-4d5c-bf9d-eee28883745b.jpg" },
        { initials:"K",  color:C.warning,  name:"Kashaf",             role:"Director Management (Head)", image:"https://i.ibb.co/XsbxBrj/kashafpic.jpg" },
        { initials:"GK", color:C.primary,  name:"Godhawari Khatri",   role:"Director Management", image:"https://i.ibb.co/mFNCWpr/godhawari.jpg" },
        { initials:"NK", color:C.accent,   name:"Naveed KK",          role:"Director Management", image:"https://i.ibb.co/Y2TgrYq/Pics-Art-12-03-10-39-57.jpg" },
        { initials:"ZS", color:"#7C3AED", name:"Zaid Ahmed Soomro",  role:"Director Management", image:"https://i.ibb.co/qYnNRvp/FB-IMG-1644979419805.jpg" },
        { initials:"FQ", color:C.success,  name:"Farheen Qazi",       role:"Director Editorial (Head)", image:"https://bit.ly/farheen-qazi-director-editorial" },
        { initials:"JA", color:"#DB2777", name:"Junaid Aslam",       role:"Director Editorial", image:"https://i.ibb.co/hBVXsxM/PU2ap-SR-400x400.jpg" },
        { initials:"FA", color:C.warning,  name:"Faeez Ahmed",        role:"Director Designer (Head)", image:"https://i.ibb.co/kQcz3Vb/IMG-20220210-101854-608.jpg" },
        { initials:"MU", color:C.primary,  name:"Muhammad Usama",     role:"Director Designer", image:"https://i.ibb.co/bPVw05z/Whats-App-Image-2022-05-31-at-12-16-55-PM.jpg" },
        { initials:"PS", color:C.accent,   name:"Paras Soomro",       role:"Director Designer", image:"https://i.ibb.co/wCdd3hL/Whats-App-Image-2022-05-31-at-10-52-04-PM.jpg" },
        { initials:"MU", color:"#7C3AED", name:"Muhammad Usman",     role:"Director Marketing (Head)", image:"https://i.ibb.co/J7jGvtR/IMG-20220527-113815.jpg" },
        { initials:"LA", color:C.success,  name:"Laraib Ayoub",       role:"Director Marketing", image:"https://i.ibb.co/K5hy59m/Whats-App-Image-2022-05-28-at-11-18-31-PM.jpg" },
        { initials:"KG", color:"#DB2777", name:"Kubra Ghafoor",      role:"Director Media (Head)", image:"https://i.ibb.co/WK9bfR4/Whats-App-Image-2022-05-26-at-9-23-59-PM.jpg" },
        { initials:"AK", color:C.warning,  name:"Anjali Kumari",      role:"Director Media", image:"https://i.ibb.co/CmdKBQn/D430-AB40-F4-CF-406-A-92-D9-460822257-B42.jpg" },
        { initials:"MD", color:C.primary,  name:"Muhammad Daniyal",   role:"Director Media", image:"https://i.ibb.co/hB3r9Qm/1653762777611.jpg" },
        { initials:"HS", color:C.accent,   name:"Hasnain Seelro",     role:"Director Logistics", image:"https://i.ibb.co/pnBptD9/IMG-1618.jpg" },
        { initials:"SA", color:"#7C3AED", name:"Syed Arham Abbas",   role:"Director Logistics", image:"https://i.ibb.co/yPdrLPN/8-EA9-CEC6-8245-417-A-A9-B5-364-CBA1-D2-B1-F.jpg" },
        { initials:"SK", color:C.success,  name:"Summaiya Khan",      role:"Director Photography", image:"https://i.ibb.co/nRLmtbP/IMG-20220505-160247-272.webp" },
        { initials:"MA", color:"#DB2777", name:"Moiz Azam",          role:"Director Photography", image:"https://i.ibb.co/Z8cWVRr/AKS-6077.jpg" },
        { initials:"S",  color:C.warning,  name:"Shumaim",            role:"Organizing Council (Head)", image:"https://i.ibb.co/wMtT2kf/888-F1586-DC98-4081-BA33-56-E31-A8-A5-DC2.jpg" },
        { initials:"AK", color:C.primary,  name:"Adarsh Kumar",       role:"Organizing Council", image:"https://i.ibb.co/H20W3FY/1629917930966.jpg" },
        { initials:"FN", color:C.accent,   name:"Faiz Nadeem",        role:"Organizing Council", image:"https://i.ibb.co/JzJFJB8/1651265657944.jpg" },
        { initials:"AR", color:"#7C3AED", name:"Ali Raza",           role:"Organizing Council", image:"https://i.ibb.co/MpyHw90/Whats-App-Image-2022-05-31-at-12-22-34-PM.jpg" },
        { initials:"AA", color:C.success,  name:"Alishba Aleem",      role:"Organizing Council", image:"https://i.ibb.co/8Y1d3LH/IMG-20201120-WA0003.jpg" },
        { initials:"AA", color:"#DB2777", name:"Ayesha Ali",         role:"Organizing Council", image:"https://i.ibb.co/z2jcxND/Whats-App-Image-2022-05-27-at-2-30-48-PM.jpg" },
        { initials:"AA", color:C.warning,  name:"Amber Arain",        role:"Organizing Council", image:"https://i.ibb.co/nc3BQLK/IMG-20220210-WA0010.jpg" },
        { initials:"HA", color:C.primary,  name:"Hira Amir",          role:"Organizing Council", image:"https://i.ibb.co/ZzsWDRd/Whats-App-Image-2022-05-31-at-12-00-58-PM.jpg" },
        { initials:"AR", color:C.accent,   name:"Amaar Raza",         role:"Organizing Council", image:"https://i.ibb.co/DMXs7ZX/amaar.jpg" },
        { initials:"ZK", color:"#7C3AED", name:"Zarmeena Khan",      role:"Organizing Council", image:"https://i.ibb.co/cYDfzZV/IMG-20220609-WA0003.jpg" },
      ],
      achievements: [
        "Organized SPEOD (Software Project Exhibition Open Day) 2023",
        "Hosted Study in Abroad - Exchange Program Pathways session",
        "Launched LaTeX Workshop for final year students",
        "Organized Awareness Session on Freelancing",
        "Established strong foundation for future batches",
      ],
    },
    {
      year: "2020-2021",
      members: [
        { initials:"Y",  color:C.primary,  name:"Yusra",             role:"President", image:"https://i.ibb.co/HxsP1mp/1653583383770.jpg" },
        { initials:"IG", color:C.accent,   name:"Iqra Ghani",        role:"Vice President", image:"https://i.ibb.co/K9CNM6g/1628719299077.jpg" },
        { initials:"R",  color:"#7C3AED", name:"Ramsha",            role:"Treasurer", image:"https://i.ibb.co/f1GBvjy/ramsha.jpg" },
        { initials:"A",  color:C.success,  name:"Altamash",          role:"General Secretary", image:"https://i.ibb.co/NpwsNmb/1641044713158.jpg" },
        { initials:"MI", color:"#DB2777", name:"Maha Isham",        role:"Joint Secretary", image:"https://i.ibb.co/HLyJ30n/1638104217133.jpg" },
        { initials:"RW", color:C.warning,  name:"Rashid Wassan",     role:"Director Management", image:"https://i.ibb.co/dDny7K3/1653636233405.jpg" },
        { initials:"B",  color:C.primary,  name:"Bakhtawar",         role:"Director Management", image:"" },
        { initials:"M",  color:C.accent,   name:"Muskan",            role:"Director Management", image:"https://i.ibb.co/9ZHGXQX/Muskan.jpg" },
        { initials:"U",  color:"#7C3AED", name:"Umesh",             role:"Director Management", image:"https://i.ibb.co/KK1ddqL/1608555369211.jpg" },
        { initials:"DM", color:C.success,  name:"Dua Mir",           role:"Director Editorial", image:"https://i.ibb.co/Vw4DRDT/47ftxz-T5-400x400.jpg" },
        { initials:"SP", color:"#DB2777", name:"Shahzad Panwhar",   role:"Director Editorial", image:"https://i.ibb.co/TRkzbBS/1636121956096.jpg" },
        { initials:"RI", color:C.warning,  name:"Rohat Iftikhar",    role:"Director Designer", image:"https://i.ibb.co/5rKxdcF/1629632270705.jpg" },
        { initials:"M",  color:C.primary,  name:"Misbah",            role:"Director Designer", image:"" },
        { initials:"S",  color:C.accent,   name:"Shumaila",          role:"Director Designer", image:"https://i.ibb.co/QcfqnN5/1654072846516.jpg" },
        { initials:"L",  color:"#7C3AED", name:"Laiba",             role:"Director Marketing", image:"https://i.ibb.co/tKGj34b/1-14a-Wrmw-qk-Vv-HHPts-PH7s-Q.jpg" },
        { initials:"AJ", color:C.success,  name:"Aemon Jabbar",      role:"Director Marketing", image:"https://i.ibb.co/y8K4s73/49372579.jpg" },
        { initials:"SL", color:"#DB2777", name:"Saqib Liaquat",     role:"Director Marketing", image:"https://i.ibb.co/kyDvVcy/1637080435507.jpg" },
        { initials:"F",  color:C.warning,  name:"Fahad",             role:"Director Media", image:"https://i.ibb.co/q0yjQYg/fahad-chandio-Klmhq-Zv.webp" },
        { initials:"DA", color:C.primary,  name:"Dua Ali",           role:"Director Media", image:"https://i.ibb.co/ThgZB1g/1631888884670.jpg" },
        { initials:"SF", color:C.accent,   name:"Sana Faiz",         role:"Director Media", image:"" },
        { initials:"M",  color:"#7C3AED", name:"Mubashir",          role:"Director Logistics", image:"https://i.ibb.co/MkLNntb/275122254-1200417870496290-8882352159459391622-n.jpg" },
        { initials:"AA", color:C.success,  name:"Abdul Aziz",        role:"Director Logistics", image:"https://i.ibb.co/pQ1G7LS/1613892636188.jpg" },
        { initials:"T",  color:"#DB2777", name:"Tabish",            role:"Director Photography", image:"https://i.ibb.co/6nDbkKn/4-A2-E873-F-69-F4-4523-BAC7-9-C45-BC93-CD80.jpg" },
        { initials:"N",  color:C.warning,  name:"Nikash",            role:"Director Photography", image:"" },
        { initials:"G",  color:C.primary,  name:"Gulwish",           role:"Organizing Council", image:"" },
        { initials:"AA", color:C.accent,   name:"Amna Afzal",        role:"Organizing Council", image:"" },
        { initials:"AI", color:"#7C3AED", name:"Aisha Isani",       role:"Organizing Council", image:"https://i.ibb.co/ZxLDcB1/1637316323220.jpg" },
        { initials:"ST", color:C.success,  name:"Sumair Tahir",      role:"Organizing Council", image:"https://i.ibb.co/3SsRYKB/1653080147291.jpg" },
        { initials:"R",  color:"#DB2777", name:"Rumisa",            role:"Organizing Council", image:"https://i.ibb.co/47C5Gzr/rumisa-khan-9b6z1qk.webp" },
        { initials:"NA", color:C.warning,  name:"Noor Ahmed",        role:"Organizing Council", image:"https://i.ibb.co/5W9gNYH/1639606762673.jpg" },
        { initials:"NZ", color:C.primary,  name:"Nittalia Zaheer",   role:"Organizing Council", image:"https://i.ibb.co/8gMJSMt/1646980990540.jpg" },
        { initials:"FR", color:C.accent,   name:"Fiza Rasheed",      role:"Organizing Council", image:"" },
        { initials:"HH", color:"#7C3AED", name:"Hira Hanif",        role:"Organizing Council", image:"" },
        { initials:"NK", color:C.success,  name:"Nimra Khan",        role:"Organizing Council", image:"https://i.ibb.co/RNwhxVV/1634240371834.jpg" },
        { initials:"SA", color:"#DB2777", name:"Sameer Akhtari",    role:"Organizing Council", image:"https://i.ibb.co/PzDgwL4/1616000207288.jpg" },
        { initials:"FS", color:C.warning,  name:"Farwa Shaikh",      role:"Organizing Council", image:"https://i.ibb.co/hmNB6pJ/266354815-1110013369826536-3579249973461481512-n.jpg" },
      ],
      achievements: [
        "Navigated SES through COVID-19 pandemic challenges",
        "Established virtual event hosting capabilities",
        "Built strong organizational foundation",
        "Mentored junior batches during difficult times",
      ],
    },
    {
      year: "2019-2020",
      members: [
        { initials:"AS", color:C.primary,  name:"Abdul Samad",       role:"President", image:"https://i.ibb.co/HgmNfjs/FB-IMG-1654330000698.jpg" },
        { initials:"SB", color:C.accent,   name:"Saira Bano",        role:"Vice President", image:"https://i.ibb.co/1bVF972/FB-IMG-1654329986174.jpg" },
        { initials:"AA", color:"#7C3AED", name:"Atib Adil",         role:"Treasurer", image:"https://i.ibb.co/XWNZb7J/FB-IMG-1654329995434.jpg" },
        { initials:"SA", color:C.success,  name:"Servech Ali",       role:"General Secretary", image:"https://i.ibb.co/RhWf4vY/FB-IMG-1654329993402.jpg" },
        { initials:"IA", color:"#DB2777", name:"Inayat Ali",        role:"Head Director Operations", image:"https://i.ibb.co/k0NxHyF/FB-IMG-1654330021912.jpg" },
        { initials:"HS", color:C.warning,  name:"Hamza Shaikh",      role:"Head Director General", image:"https://i.ibb.co/zQzWrzK/FB-IMG-1654330017909.jpg" },
        { initials:"AS", color:C.primary,  name:"Ali Siyal",         role:"Head Director Media", image:"https://i.ibb.co/Tq57JNq/FB-IMG-1654330045855.jpg" },
        { initials:"YM", color:C.accent,   name:"Yar Muhammad",      role:"Head Director Logistics", image:"https://i.ibb.co/2cNxf11/FB-IMG-1654330039669.jpg" },
        { initials:"KK", color:"#7C3AED", name:"Khubaib Khatri",    role:"Head Director Photography", image:"https://i.ibb.co/DgzBscT/FB-IMG-1654330035119.jpg" },
        { initials:"FA", color:C.success,  name:"Fiza Azam",         role:"Head Director Designing", image:"https://i.ibb.co/VM08ZGw/FB-IMG-1654330028575.jpg" },
        { initials:"M",  color:"#DB2777", name:"Mahnoor",           role:"Director Operations", image:"https://i.ibb.co/vmYGGz9/FB-IMG-1654330023958.jpg" },
        { initials:"SA", color:C.warning,  name:"Sara Aftab",        role:"Director General", image:"https://i.ibb.co/3dZRQWd/FB-IMG-1654330019957.jpg" },
        { initials:"AH", color:C.primary,  name:"Afhsan Hanif",      role:"Director Media", image:"https://i.ibb.co/8N64wc5/FB-IMG-1654330048730.jpg" },
        { initials:"SG", color:C.accent,   name:"Sandesh Gangwani",  role:"Director Logistics", image:"https://i.ibb.co/TLRvrBC/FB-IMG-1654330041699.jpg" },
        { initials:"AJ", color:"#7C3AED", name:"Asad Jatoi",        role:"Director Photography", image:"https://i.ibb.co/McLC4W6/FB-IMG-1654330037101.jpg" },
        { initials:"AR", color:C.success,  name:"Asad Rajput",       role:"Director Designing", image:"https://i.ibb.co/JsxNZJn/FB-IMG-1654330030721.jpg" },
        { initials:"KI", color:"#DB2777", name:"Kashaf Irshad",     role:"Director Operations", image:"https://i.ibb.co/xgvHMz5/FB-IMG-1654330026607.jpg" },
        { initials:"DM", color:C.warning,  name:"Damini Mukhi",      role:"Director Media", image:"https://i.ibb.co/ySrRnLw/FB-IMG-1654330050813.jpg" },
        { initials:"JC", color:C.primary,  name:"Jawad Chandio",     role:"Director Logistics", image:"https://i.ibb.co/XXzSkFH/FB-IMG-1654330043700.jpg" },
        { initials:"U",  color:C.accent,   name:"Urmila",            role:"Director Designing", image:"https://i.ibb.co/VDvTyXW/FB-IMG-1654330032674.jpg" },
      ],
      achievements: [
        "Established SES MUET organizational structure",
        "Organized first major SES events",
        "Built initial partnerships with industry",
    ...
    },
    {
      year: "2018-2019",
      members: [
        { initials:"HA", color:C.primary,  name:"Haris Ahmed",       role:"President", image:"https://i.ibb.co/LJySQ69/FB-IMG-1656753428358.jpg" },
        { initials:"M",  color:C.accent,   name:"Mashal",            role:"Vice President", image:"https://i.ibb.co/jwbnkLB/FB-IMG-1656753430335.jpg" },
        { initials:"S",  color:"#7C3AED", name:"Sanaullah",         role:"Treasurer", image:"https://i.ibb.co/wyKt5PB/FB-IMG-1656753439291.jpg" },
        { initials:"HA", color:C.success,  name:"Hira Abid",         role:"General Secretary", image:"https://i.ibb.co/TBThPpR/FB-IMG-1656753432592.jpg" },
        { initials:"BS", color:"#DB2777", name:"Bhagia Sheri",      role:"Director General", image:"https://i.ibb.co/KXbM17Y/FB-IMG-1656753442061.jpg" },
        { initials:"SB", color:C.warning,  name:"Saira Bano",        role:"Director General", image:"https://i.ibb.co/dPBpS8p/FB-IMG-1656753487453.jpg" },
        { initials:"AS", color:C.primary,  name:"Abdul Samad",       role:"Director General", image:"https://i.ibb.co/gvtPX5j/FB-IMG-1656753489555.jpg" },
        { initials:"MR", color:C.accent,   name:"Mussaib Rasheed",   role:"Director Photography", image:"https://i.ibb.co/xGWmqwM/FB-IMG-1656753491661.jpg" },
        { initials:"AR", color:"#7C3AED", name:"Aqib Raza",         role:"Director Photography", image:"https://i.ibb.co/X8Hq9Qh/FB-IMG-1656753504103.jpg" },
        { initials:"K",  color:C.success,  name:"Khubaib",           role:"Director Photography", image:"https://i.ibb.co/v1H6kp9/FB-IMG-1656753507803.jpg" },
        { initials:"AZ", color:"#DB2777", name:"Asmatullah Zubair", role:"Director Logistic", image:"https://i.ibb.co/68ybyrQ/FB-IMG-1656753510095.jpg" },
        { initials:"GM", color:C.warning,  name:"Ghulam Mustafa",    role:"Director Logistics", image:"https://i.ibb.co/R2vhv90/FB-IMG-1656753513083.jpg" },
        { initials:"AA", color:C.primary,  name:"Ateeb Adil",        role:"Director Logistics", image:"https://i.ibb.co/n80rS3z/FB-IMG-1656753515083.jpg" },
        { initials:"SA", color:C.accent,   name:"Servech Ali",       role:"Director Media", image:"https://i.ibb.co/x2nnr5X/FB-IMG-1656753517234.jpg" },
        { initials:"P",  color:"#7C3AED", name:"Pooja",             role:"Director Media", image:"https://i.ibb.co/QF0r6fm/FB-IMG-1656753519247.jpg" },
        { initials:"R",  color:C.success,  name:"Roofa",             role:"Director Media", image:"https://i.ibb.co/rfnqhxr/FB-IMG-1656753526078.jpg" },
        { initials:"K",  color:"#DB2777", name:"Komal",             role:"Director Media", image:"https://i.ibb.co/PChhtmL/FB-IMG-1656753528296.jpg" },
        { initials:"NZ", color:C.warning,  name:"Nida Zafar",        role:"Director Design", image:"https://i.ibb.co/jzcQg4Q/FB-IMG-1656753532243.jpg" },
        { initials:"MM", color:C.primary,  name:"Muhammad Muzammil", role:"Director Design", image:"https://i.ibb.co/72F8kDc/FB-IMG-1656753534879.jpg" },
        { initials:"PH", color:C.accent,   name:"Pir Hamid Ali",     role:"Director Design", image:"https://i.ibb.co/HFPZ9hC/FB-IMG-1656753536873.jpg" },
      ],
      achievements: [
        "Founded SES MUET - the beginning of a legacy",
        "Established initial team structure",
        "Created first SES events and activities",
        "Set the vision for Software Engineering Society",
      ],
    },
  ];
